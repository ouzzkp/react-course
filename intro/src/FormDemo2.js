                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormGroup>
                        ...
                        <Input type="select" name="city" id="city"onChange={this.handleChange}>
                            ...
                            <option>İzmir</option>
                            <option>Kastomnu</option>
                        </Input>
                    </FormGroup>
                    <FormGroup>
                        <Label for="description">Description</Label>
                        <Input type="description" name="description" id="description" placeholder="Enter description" onChange={this.handleChange}></Input>
                    </FormGroup>
                    <Button type='submit' onChange={this.handleSubmit}>Save</Button>
                </Form>
            </div>
        )
    }
